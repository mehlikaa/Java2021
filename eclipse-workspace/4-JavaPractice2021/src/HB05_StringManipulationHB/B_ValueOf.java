...
public class B_ValueOf {
    public static void main(String[] args) {
        ...
        // me
        short sayim=75;
        System.out.println("--me--- Shorttan Stringe => "+Short.toString(sayim)+15+"Nasil?");
        // --me
...
//me
        System.out.println("--me--Bagis toplami : "+ (Integer.parseInt(bagis1)+Integer.parseInt(bagis2)) );
