...
public class JavaMarket {
	...
	static List<String> urunlerin=new ArrayList<>(Arrays.asList("00 Domates","01 Patates","02 Biber","03 Sogan","04 Havuç","05 Elma","06 Muz","07 Çilek","08 Kavun","09 Üzüm","10 Limon"));
    ...
    public static void main(String[] args) {
    	...
    	do {
    		urunListesi();
    		System.out.print("Sectigininiz urunun kodunu giriniz : ");
    		int urunNo=scan.nextInt();
    		System.out.print("Kac kg alacaginizi giriniz : ");
    		double kg=scan.nextDouble();
    		sepeteEkle(urunNo,kg);
    		toplamFiyat=sepetTutari();
    		
    		System.out.print("\nYeni urun ekleyecek misiniz ? :  ");
    		devam=scan.next();
	...
	private static double sepetTutari() {
		...
		System.out.print("Toplam odemeniz gereken miktar "+septTutar+"     Aldiginiz urunun miktari (kg) : "+sptKg);
	...
	private static void odeme(Double toplamFiyat) {
		...
		System.out.println("\nOdemeniz gereken tutar : "+toplamFiyat);
		double nakit=0;
		do {
			...
			if (nakit<toplamFiyat) {
				System.out.println("Eksik odeme yaptiniz : " + (toplamFiyat-nakit)+ " odemelisiniz.");
			}
		...
		if (paraUstu>0) {
			System.out.println("ParaUstunuz : "+ paraUstu);
		}
		System.out.println("=====Yine bekleriz, tesekkurler=====");
	}
